...
classdata %>%
  ...
  kbl(caption = "Summary statistics of scores for each exam version.",
...
stem_cell %>%
  ...
  kbl(caption = "Summary statistics of the embryonic stem cell study.",
...
boot_2mean %>%
  ...
  labs(
    title = "Simulation-Based Bootstrap Distribution for Diff in Means",
...
ncbirths %>% 
  ...
  head(4) %>%
  kbl(caption = caption_helper("Four cases from the `ncbirths` data set. The missing cells in the first two entries of the first variable, indicates that piece of data is missing."),
...
ncbirths_sample_stats %>%
  kbl(caption = caption_helper("Summary statistics for the `ncbirths` data set."),
