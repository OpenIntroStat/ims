...
ncbirths %>% 
  ...
  head(4) %>%
  kbl(booktabs = TRUE, caption = caption_helper("Four cases from the `ncbirths` data set. The missing cells in the first two entries of the first variable, indicates that piece of data is missing."),
...
ncbirths_sample_stats %>%
  kbl(booktabs = TRUE, caption = caption_helper("Summary statistics for the `ncbirths` data set."),
