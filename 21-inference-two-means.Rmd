...
::: {.data data-latex=""}
The [`classdata`](http://openintrostat.github.io/openintro/reference/classdata.html) data from this study can be found in the [**openintro**](http://openintrostat.github.io/openintro) R package.
:::
...
::: {.data data-latex=""}
The [`stem_cell`](http://openintrostat.github.io/openintro/reference/stem_cell.html) data from this study can be found in the [**openintro**](http://openintrostat.github.io/openintro) R package.
:::
...
::: {.data data-latex=""}
The [`births14`](http://openintrostat.github.io/openintro/reference/births14.html) data from this study can be found in the [**openintro**](http://openintrostat.github.io/openintro) R package.
:::
...
::: {.guidedpractice data-latex=""}
The summary statistics in Table \@ref(tab:tab:births14-summary-stats) may be useful for this Guided Practice.
What is the point estimate of the population difference, $\mu_{n} - \mu_{s}$?[^inference-two-means-3]
:::

[^inference-two-means-3]: The point estimate of the population difference ($\bar{x}_{n} - \bar{x}_{s}$) is `r xbar_difference`.
...
::: {.guidedpractice data-latex=""}
Compute the standard error of the point estimate for the average difference between the weights of babies born to nonsmoker and smoker mothers.[^inference-two-means-4]
:::

[^inference-two-means-4]: The standard error of the estimate can be calculated using the standard error formula: $SE = \sqrt{\frac{\sigma_{n}^2}{n_n} + \frac{\sigma_s^2}{n_s}} \approx \sqrt{\frac{s_n^2}{n_n} + \frac{s_s^2}{n_s}} = \sqrt{\frac{1.23^2}{867} + \frac{1.60^2}{114}} = `r se_difference`.$
...
Furthermore, health differences between babies born to mothers who smoke and those who do not are not limited to weight differences.[^inference-two-means-5]

[^inference-two-means-5]: You can watch an episode of John Oliver on [*Last Week Tonight*](youtu.be/6UsHHOCH4q8) to explore the present day offenses of the tobacco industry.
