...
ncbirths %>% 
  ...
  head(4) %>%
  kbl(linesep = "", booktabs = TRUE, caption = caption_helper("Four cases from the `ncbirths` dataset. The missing cells in the first two entries of the first variable, indicates that piece of data is missing."),
...
ncbirths_sample_stats %>%
  kbl(linesep = "", booktabs = TRUE, caption = caption_helper("Summary statistics for the `ncbirths` dataset."),
