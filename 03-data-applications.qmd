...
```{r}
#| label: passwords-online-crack-summary
passwords %>%
  group_by(time_unit) %>%
  summarise(
    n   = n(),
...
```{r}
#| label: password-offline-crack-hist
...
```{r}
#| label: password-strength-rank-category
...
::: {.content-visible when-format="pdf"} https://openintrostat.github.io/ims-tutorials/01-data
:::
...
::: {.content-visible when-format="pdf"} https://openintro.shinyapps.io/ims-01-data-01
:::
...
::: {.content-visible when-format="pdf"} https://openintro.shinyapps.io/ims-01-data-02
:::
...
::: {.content-visible when-format="pdf"} https://openintro.shinyapps.io/ims-01-data-03
:::
...
::: {.content-visible when-format="pdf"} https://openintro.shinyapps.io/ims-01-data-04
:::
