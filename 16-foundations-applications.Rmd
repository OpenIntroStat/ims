...
::: {.data data-latex=""}
The data from this study can be found in the [**openintro**](http://openintrostat.github.io/openintro) R package: [`malaria`](http://openintrostat.github.io/openintro/reference/malaria.html).
:::
...
malaria_rand %>%
  ...
  pivot_wider(names_from = outcome, values_from = n) %>%
  adorn_totals(where = c("row", "col")) %>%
  kbl(booktabs = TRUE, caption = "Simulation results, where any difference in infection ratio is purely due to chance.")
```
