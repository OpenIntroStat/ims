...
* [Chapter -@sec-data-applications] was re-written with an updated context and data example. Additionally, in @sec-data-applications, we explore Simpson's Paradox. 
