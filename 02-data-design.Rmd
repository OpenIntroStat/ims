...
3.  **Replication.** The more cases researchers observe, the more accurately they can estimate the effect of the explanatory variable on the response.
    ...
    **Pseudoreplication** occurs when individual observations under different treatments are heavily dependent on each other.
    For example, suppose you have 50 subjects in an experiment where you are taking blood pressure measurements at 10 time points throughout the course of the study.
...
Researchers are not usually interested in the emotional effect, which might bias the study.
...
But there is one problem: if a patient does not receive a treatment, they will know they are in the control group.
