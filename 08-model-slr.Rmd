...
One important aspect of the correlation is that it's *unitless* That is, unlike a measurement of the slope of a line (see the next section) which provides an increase in the y-coordinate for a one unit increase in the x-coordinates (in units of the x and y variable), there are no units associated with the correlation.
...
m_total_pr_cond_tidy %>%
  ...
  kbl(booktabs = TRUE, caption = "Least squares regression summary for the final auction price against the condition of the game.", digits = 2, align = "lrrrr") %>%
  kable_styling(bootstrap_options = c("striped", "condensed"), 
                latex_options = c("striped", "hold_position"), full_width = FALSE) %>%
