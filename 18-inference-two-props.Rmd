...
malaria %>%
  ...
  kbl(caption = "Summary results for the malaria vaccine experiment.",
...
fish_oil_18[[3]] %>% 
  ...
  kbl(caption = "Results for the study on n-3 fatty acid supplement and related health benefits.", 
