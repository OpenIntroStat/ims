...
malaria %>%
  ...
  kbl(booktabs = TRUE, caption = "Summary results for the malaria vaccine experiment.",
...
```{r malaria-rand-dot-plot-18, fig.cap="(ref:malaria-rand-dot-plot-18-cap)"}
set.seed(19)
malaria %>%
...
(ref:malaria-rand-dot-plot-18-cap) A stacked dot plot of differences from 100 simulations produced under the independence model $H_0,$ where in these simulations infections are unaffected by the vaccine. Two of the 100 simulations had a difference of at least 64.3%, the difference observed in the study.
...
How often would you observe a difference of at least 64.3% (0.643) according to Figure \@ref(fig:malaria-rand-dot-plot-18)?
Often, sometimes, rarely, or never?

------------------------------------------------------------------------

It appears that a difference of at least 64.3% due to chance alone would only happen about 2% of the time according to Figure \@ref(fig:malaria-rand-dot-plot-18).
...
```{r boot2propresamps, fig.cap = "Taking each bootstrap sample from the estimated population.", warning = FALSE, out.width = "95%"}
...
```{r boot2samp2, fig.cap = "For example, the first bootstrap resamples from Sample 1 and Sample 2 provide resample proportions of 2/7 and 5/9, respectively.", warning = FALSE, out.width="75%"}
...
```{r boot2samp1, fig.cap = "The differences in each bootstrapped pair of proportions are combined to create the sampling distribution of the differences in proportions.", warning = FALSE,  out.width="95%"}
...
ggplot(cpr_boot_dist, aes(x = stat)) +
  ...
  annotate("text", x = cpr_boot_90_lower_perc, y = 190, label = "5 percentile") +
  annotate("text", x = cpr_boot_90_upper_perc, y = 190, label = "95 percentile")
```
...
## Mathematical model for $p_1 - p_2$ {#math-2prop}
...
fish_oil_18[[3]] %>% 
  ...
  kbl(booktabs = TRUE, caption = "Results for the study on n-3 fatty acid supplement and related health benefits.", 
