...
::: {.workedexample data-latex=""}} How often would you observe a difference of at least 64.3% (0.643) according to Figure \@ref(fig:malaria-rand-dot-plot)?
...
::: {.workedexample data-latex=""}} We reconsider the experiment for patients who underwent cardiopulmonary resuscitation (CPR) for a heart attack and were subsequently admitted to a hospital.
...
::: {.workedexample data-latex=""}} Create and interpret a 90% confidence interval of the difference for the survival rates in the CPR study.
...
::: {.data data-latex=""}
These data can be found in the [openintro](http://openintrostat.github.io/openintro) package: [`mammogram`](http://openintrostat.github.io/openintro/reference/mammogram.html).
:::
...
::: {.workedexample data-latex=""}} Is it reasonable to model the difference in proportions using a normal distribution in this study?
...
::: {.workedexample data-latex=""}} Compute the point estimate of the difference in breast cancer death rates in the two groups, and use the pooled proportion $\hat{p}_{\textit{pool}} = 0.0112$ to calculate the standard error.
...
::: {.workedexample data-latex=""}} Using the point estimate $\hat{p}_{MGM} - \hat{p}_{C} = -0.00012$ and standard error $SE = 0.00070,$ calculate a p-value for the hypothesis test and write a conclusion.
