...
### Randomization distribution of the chi-squared statistic
...
#### Observed statistic vs. null chi-squared statistics {.unnumbered}
...
::: {.important}
**Computing degrees of freedom for a two-way table.** When applying the chi-squared test to a two-way table, we use $df = (R-1)\times (C-1)$ where $R$ is the number of rows in the table and $C$ is the number of columns.
:::
