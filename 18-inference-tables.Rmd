...
As seen in Chapters \@ref(foundation-randomization), \@ref(foundation-bootstrapping) and \@ref(foundation-mathematical), but fully realized here in Chapter \@ref(inference-one-prop), almost all the research questions can be approached using computational methods (e.g., randomization tests or bootstrapping) or using mathematical models.
