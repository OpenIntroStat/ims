...
```{r chisqDistDF, fig.cap="The chi-squared distribution for differing degrees of freedom.  The larger the degrees of freedom, the longer the right tail extends.", warning=FALSE, fig.width=10}
