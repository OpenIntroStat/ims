...
```{r tDistDF20RightTail1Point65, fig.cap = "Top: The $t$-distribution with 20 degrees of freedom, with the area above 1.65 shaded. Bottom: The $t$-distribution with 2 degrees of freedom, with the area further than 3 units from 0 shaded.", out.width="50%"}
normTail(U = 1.65,
  df = 12,
  xlim = c(-4, 4),
  col = IMSCOL["blue", "full"])
...
::: {.exercises}
```{r exercises-20, child = "exercises/20-ex-inference-one-mean.Rmd"}
```
:::
