...
```{r CPR_study_right_tail, fig.cap="Null distribution of the point estimate for the differenvce in proportions. The shaded right tail shows observations that are at least as large as the observed difference, 0.13.", warning=FALSE, fig.width=10}
...
```{r CPR_study_p_value, fig.cap="Null distribution of the point estimate, $\hat{p}_t - \hat{p}_c$. All values that are at least as extreme as +0.13 but in either direction away from 0 are shaded.", warning=FALSE, fig.width=10}
