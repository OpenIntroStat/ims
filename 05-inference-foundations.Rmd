...
```{r FourCaseStudies, fig.cap="The null distribution for each of the four case studies presented in Sections \\@ref(caseStudyOpportunityCost), \\@ref(caseStudyGenderDiscrimination), \\@ref(sec-med-consult), and \\@ref(tapperscasestudy).", warning=FALSE, fig.width=10}
...
```{r twoSampleNormalsStacked, fig.cap="The two normal models shown in Figure \\@ref(twoSampleNormals) but plotted together on the same scale.", warning=FALSE, fig.width=10}
