...
```{r FourCaseStudies, fig.cap="The null distribution for each of the four case studies presented in Sections \\ref{caseStudyOpportunityCost}-\\ref{SimulationCaseStudies}.", warning=FALSE, fig.width=10}
...
```{r diffInTextbookPricesS10_CLTsection, fig.cap="Histogram of the difference in price for each book sampled. These data are strongly skewed.\index{skew!example: strong}\textA{\vspace{-3mm}}", warning=FALSE, fig.width=10}
