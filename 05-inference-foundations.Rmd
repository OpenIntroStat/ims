...
```{r diffInTextbookPricesS10_CLTsection, fig.cap="Histogram of the difference in price for each book sampled. These data are strongly skewed.", warning=FALSE, fig.width=10, message = FALSE}
...
```{r elmhurstScatterWLSROnly_CLTsection, fig.cap="Gift aid and family income for a random sample of 50 first-year students from Elmhurst College, shown with a regression line.", warning=FALSE, fig.width=10, message = FALSE}
