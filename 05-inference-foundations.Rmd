...
temptbl %>%
  kable(caption = "The data from Table \@ref(tab:OpportunityCostTable) summarized using row proportions. Row proportions are particularly useful here since we can view the proportion of *buy* and *not buy* decisions in each group.",
        col.names = c("", "buy DVD", "not buy DVD", "Total")) %>%
  kable_styling() %>%
  add_header_above(c( " ", "`decision`" = 2, " "))
```
