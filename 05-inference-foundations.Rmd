...
```{r chp5summary}
  method_summary_table %>%
  filter(variable != "What are the technical conditions?") %>%
  select(variable, col1, col2) %>%
 kable(caption = "Summary and comparison of Randomization Tests and Bootstrapping as inferential statistical methods.",
    col.names = c("", " Randomization Test ", "Bootstrapping")) %>%
 kable_styling()
```
