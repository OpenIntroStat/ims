...
```{r genderrand1, out.width="100%", fig.cap="The gender descriminiation study can be thought of as 48 red and black cards."}
...
```{r genderrand1, out.width="100%", fig.cap="The gender descriminiation data is shuffled and reallocated to the gender groups."}
...
```{r genderrand1, out.width="100%", fig.cap="We summarize the randomized data to produce one estiamte of the difference in proportions given no gender discrimination."}
...
```{r genderrand1, out.width="100%", fig.cap="An example of one simulation of the full randomization procedure.  We repeat the steps hundreds or thousands of times."}
