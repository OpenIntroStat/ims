...
## Inference through randomization {#inf-rand}
...
include_graphics("05/figures/genderrand1.png")
```

```{r genderrand1b, out.width="50%", fig.cap="Take 2: The gender descriminiation study can be thought of as 48 red and black cards."}
...
include_graphics("05/figures/genderrand3.png")
```

```{r genderrand3b, out.width="80%", fig.cap="Take 2: The gender descriminiation data is shuffled and reallocated to the gender groups."}
include_graphics("05/figures/genderrand3b.png")
```

```{r genderrand3c, out.width="80%", fig.cap="Take 3: The gender descriminiation data is shuffled and reallocated to the gender groups."}
include_graphics("05/figures/genderrand3c.png")
```
...
Figure \@ref(fig:genderrandfull) shows that the difference in promotion rates is much larger in the original data than it is in the simulated groups.

```{r genderrandfull, out.width="100%", fig.cap="We summarize the randomized data to produce one estiamte of the difference in proportions given no gender discrimination."}
include_graphics("05/figures/genderrandfull.png")
```

```{r genderrandfullb, out.width="100%", fig.cap="Take 2: We summarize the randomized data to produce one estiamte of the difference in proportions given no gender discrimination."}
include_graphics("05/figures/genderrandfullb.png")
```
...
### Summary: randomization test box/flow chart
...
No. The claim is that there is a causal connection, but the data are observational, so we must be on the lookout for confounding varaibles. 
