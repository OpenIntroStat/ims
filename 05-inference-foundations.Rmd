...
```{r boot2, fig.cap = "Bootstrap sampling provides a measure of the variability of sample to sample.  Note that we are taking samples from the estimated population that was created in Figure \@ref(fig:boot1).", warning = FALSE,  out.width="75%"}
