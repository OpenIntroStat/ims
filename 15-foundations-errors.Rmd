...
temptbl %>%
 kbl(caption = "Four different scenarios for hypothesis tests.", 
    col.names = c("", "", "Reject $H_0$", "Fail to reject $H_0$")) %>%
 add_header_above( c("", "", "**Test conclusion**" = 2)) %>%
 kable_styling(bootstrap_options = c("striped", "condensed"), latex_options = "striped", full_width = FALSE)
```
...
temptbl %>%
 kbl(caption = "Results for the CPR study. Patients in the treatment group were given a blood thinner, and patients in the control group were not",
