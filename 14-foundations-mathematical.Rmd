...
```{r FourCaseStudies, fig.cap = "The null distribution for each of the four case studies presented previously. Note that the center of each distribution is given by the value of the parameter set in the null hypothesis.", fig.asp = 0.8}
...
p_gd <- ggplot(gender_discrimination_sim_dist, aes(x = stat)) +
  ...
  annotate("text", x = 0, y = 500, label = "Gender discrimination", size = 6)
...
```{r simpleNormal, fig.cap = "A normal curve.", fig.asp = 0.4}
normTail(axes = FALSE)
```
