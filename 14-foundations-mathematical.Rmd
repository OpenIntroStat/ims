...
::: {.workedexample data-latex=""}} The opportunity cost study determined that students are thriftier if they are reminded that saving money now means they can spend the money later.
...
::: {.workedexample data-latex=""}} Book prices were collected for `r nrow(ucla_textbooks_f18)` courses at UCLA in Fall 2018 Data were collected from both the UCLA Bookstore and Amazon.
...
::: {.data data-latex=""}
The data from this study can be found in the [openintro](http://openintrostat.github.io/openintro) package: [`ucla_textbooks_f18`](http://openintrostat.github.io/openintro/reference/ucla_textbooks_f18.html).
:::

::: {.workedexample data-latex=""}} Elmhurst College in Illinois released anonymized data for family income and financial support provided by the school for Elmhurst's first-year students in 2011.
...
::: {.guidedpractice data-latex=""}
Use Sian's ACT score, 24, along with the ACT mean and standard deviation to compute their Z score.[^foundations-mathematical-6]
:::

[^foundations-mathematical-6]: $Z_{Sian} = \frac{x_{Sian} - \mu_{ACT}}{\sigma_{ACT}} = \frac{24 - 21}{5} = 0.6$
...
::: {.workedexample data-latex=""}} Nel from the SAT Guided Practice earned a score of 1800 on their SAT with a corresponding $Z=1.$ She would like to know what percentile they fall in among all SAT test-takers.
...
The `normTail()` function is available in the [**openintro**](http://openintrostat.github.io/openintro/) R package and will draw the associated.
...
::: {.guidedpractice data-latex=""}
Determine the proportion of SAT test takers who scored better than Nel on the SAT.[^foundations-mathematical-10]
:::

[^foundations-mathematical-10]: If 84% had lower scores than Nel, the number of people who had better scores must be 16%.
...
::: {.workedexample data-latex=""}} Shannon is a randomly selected SAT taker, and nothing is known about Shannon's SAT aptitude.
...
::: {.workedexample data-latex=""}} Edward earned a 1400 on their SAT.
...
::: {.workedexample data-latex=""}} Use the results of the previous example to compute the proportion of SAT takers who did better than Edward.
...
::: {.workedexample data-latex=""}} Kamron is 5'7'' and Adrian is 6'4''.
...
Numerical answers, calculated using statistical software (e.g., `pnorm()` in R): (a) 0.1131.
(b) 0.3821.
...
::: {.workedexample data-latex=""}} Yousef's height is at the $40^{th}$ percentile.
How tall is he?
...
::: {.workedexample data-latex=""}} What is the adult male height at the $82^{nd}$ percentile?
...
(b) What is the $97.5^{th}$ percentile of the male heights? As always with normal probability problems, first draw a picture.[^foundations-mathematical-14]
:::

[^foundations-mathematical-14]: Remember: draw a picture first, then find the Z score.
...
(b) What is the probability that a male adult is shorter than 5'9'' (69 inches)?[^foundations-mathematical-15]
:::

[^foundations-mathematical-15]: Numerical answers: (a) 0.1131.
    (b) 0.3821.

::: {.workedexample data-latex=""}} What is the probability that a randomly selected adult male is between 5'9'' and 6'2''?
...
::: {.guidedpractice data-latex=""}
What percent of SAT takers get between 1500 and 2000?[^foundations-mathematical-16]
:::

[^foundations-mathematical-16]: This is an abbreviated solution.
...
::: {.guidedpractice data-latex=""}
What percent of adult males are between 5'5'' and 5'7''?[^foundations-mathematical-17]
:::

[^foundations-mathematical-17]: 5'5'' is 65 inches.
    5'7'' is 67 inches.
...
Similarly there should be an area of about 0.95 between $Z=-2$ and $Z=2.$[^foundations-mathematical-18]
:::

[^foundations-mathematical-18]: First draw the pictures.
...
(b) What percent score between 1500 and 2100 ?[^foundations-mathematical-19]
:::

[^foundations-mathematical-19]: (a) 900 and 2100 represent two standard deviations above and below the mean, which means about 95% of test takers will score between 900 and 2100.
...
## Case Study (HT) : Opportunity cost {#caseopp}
...
```{r OpportunityCostDiffs-w-normal, fig.cap = "Null distribution of differences with an overlaid normal curve for the opportunity cost study. 10,000 simulations were run for this figure.", out.width = "100%"}
ggplot(opportunity_cost_sim_dist, aes(x = stat)) +
...
### Case study (HT): Medical consultant {#casemed}
...
## Case study (CI): Stents {#casestent}
...
::: {.guidedpractice data-latex=""}
Compute the area between -1.96 and 1.96 for a normal distribution with mean 0 and standard deviation 1.[^foundations-mathematical-20]
:::

[^foundations-mathematical-20]: We will leave it to you to draw a picture.
...
::: {.workedexample data-latex=""}} The point estimate from the opportunity cost study was that 20% fewer students would buy a video if they were reminded that money not spent now could be spent later on something else.
The point estimate from this study can reasonably be modeled with a normal distribution, and a proper standard error for this point estimate is $SE = 0.078.$ Construct a 95% confidence interval.[^foundations-mathematical-21]

[^foundations-mathematical-21]: We've used $SE = 0.078$ from the last section.
...
::: {.workedexample data-latex=""}} Consider the stent study and results.
...
::: {.guidedpractice data-latex=""}
In Figure \@ref(fig:95PercentConfidenceInterval), one interval does not contain the true proportion, $p = 0.3.$ Does this imply that there was a problem with the datasets that were selected?[^foundations-mathematical-22]
:::

[^foundations-mathematical-22]: No.
