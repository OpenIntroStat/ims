...
temptbl %>%
 kbl(caption = "Descriptive statistics for 30-day results for the stent study.",
...
inference_method_summary_table %>%
  ...
  kbl(caption = "Summary of mathematical models as an inferential statistical method.", 
