...
In Section \@ref(ConfidenceIntervals) we have introduced how to construct this interval using bootstrapping, specifically the percentile bootstrap method.
In this chapter we will evaluate whether the conditions for using a mathematical model hold for these data, and if so, use the Central Limit Theorem and the normal distribution to construct the interval.
:::
...
We'll explore this example and construct such a hypothesis test in Chapter \@ref(inference-paired-means) using the normal distribution, after confirming that the conditions necessary for using mathematical models for statistical inference hold for these data.
:::
...
For this case study, we will again evaluate whether we can use the normal distribution to help us answer this question.
:::
