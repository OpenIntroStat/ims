...
::: {.chapterintro}
In this chapter we will explore techniques for visualizing and summarizing numerical variables.
**TO DO: Enhance chapter summary.**
:::
...
In Chapter \@ref(foundation-randomization) and beyond, we will develop tools to characterize the accuracy of point estimates, like the sample mean.
