...
Consider the `loan_amount` variable from the `loan50` data set, which represents the loan size for each of 50 loans in tghe data set.
...
loan50 %>%
  ...
  kbl(align = "lccccccccc", caption = "Counts for the binned `interest_rate` data.")
```
