...
```{r}
#| label: ipod-ask-data-summary-expected
...
```{r}
#| label: ipod-ask-data-summary-rand
set.seed(4747)
...
```{r}
#| label: ipodRandDotPlot
#| fig.cap: A histogram of chi-squared statisics from 1,000 simulations produced under
...
```{r}
#| label: chisqDistDF
#| fig.cap: The chi-squared distribution for differing degrees of freedom. The larger
