...
Many of these datasets are in the [openintro](http://openintrostat.github.io/openintro) package that contains datasets used in [OpenIntro](https://www.openintro.org/)'s open-source textbooks.[^preface-2]
...
::: {.data data-latex=""}
These data can be found in the [**openintro**](http://openintrostat.github.io/openintro) R package: [`textbooks`](http://openintrostat.github.io/openintro/reference/textbooks.html).
:::
