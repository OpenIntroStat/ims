...
When using AIC for model selection, models with a lower AIC value are considered to be "better." We will look for models with a lower AIC using a backward elimination strategy.
