...
Here we'll use a statistic called **Akaike information criterion (AIC)**\index{AIC}, which is an analogue to how we used adjusted $R^2$ in multiple regression.
...
Opposite of the use of adjusted $R^2$, when using AIC for model selection, models with a lower AIC value are considered to be "better." It is important to note that AIC provide information about the quality of a model relative to other models, but does not provide information about the overall quality of a model.
