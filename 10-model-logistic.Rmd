...
resume_variables %>%
  ...
  kbl(caption = "Descriptions for nine variables from the `resume` dataset. Many of the variables are indicator variables, meaning they take the value 1 if the specified characteristic is present and 0 otherwise.", 
      booktabs = TRUE) %>%
  kable_styling(bootstrap_options = c("striped", "condensed"), 
