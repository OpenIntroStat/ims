...
[^getting-started-with-data-2]: The loan's grade is A, and the borrower rents their residence.
...
How might you organize a course's grade data using a data frame?[^getting-started-with-data-3]
:::
...
::: {.guidedpractice}
We consider data for 3,142 counties in the United States, which includes the name of each county, the state where it resides, its population in 2017, how its population changed from 2010 to 2017, poverty rate, and nine additional characteristics.
...
While this trend isn't true for every county, the trend in the plot is evident.
...
::: {.guidedpractice}
Suppose an observational study tracked sunscreen use and skin cancer, and it was found that the more sunscreen someone used, the more likely the person was to have skin cancer. Does this mean sunscreen *causes* skin cancer?^[No. See the paragraph following the question!] 
:::
...
[^getting-started-with-data-12]: Answers will vary.
    ...
    Additionally, the high density may contribute to increases in property value, making homeownership infeasible for many residents.
...
[^getting-started-with-data-16]: The researchers assigned the patients into their treatment groups, so this study was an experiment.
    However, the patients could distinguish what treatment they received, so this study was not blind.
