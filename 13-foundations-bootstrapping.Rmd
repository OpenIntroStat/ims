...
::: {.guidedpractice data-latex=""}
Do the data provide strong evidence against the claim that 50% of listeners can guess the tapper's tune?[^foundations-bootstrapping-3]
:::

[^foundations-bootstrapping-3]: Because 50% is not in the interval estimate for the true parameter, we can say that there is strong evidence against the hypothesis that 50% of listeners can guess the tune.
    Moreover, 50% is a substantial distance from the largest resample statistic, suggesting that there is **very** strong evidence against this hypothesis.
