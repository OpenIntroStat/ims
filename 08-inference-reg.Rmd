...
```{r slopes, echo = FALSE, fig.cap = "If repeated samples of size 20 are taken from the entire population, each linear model will be slightly different."}
...
The inferential model should also focus on the interpretation of the coefficients which is done while *everything else* is held constant.  In situations of multicollinearity, it is often difficult to hold everything else constant.  See coin example.
