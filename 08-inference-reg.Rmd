...
\mbox{Model } B: && E[\texttt{body_mass_g}] = \beta_0 + \beta_1 \times \texttt{bill_length_mm} + \beta_2 \times \texttt{bill_depth_mm} + \\
&& \beta_3 \times \texttt{flipper_length_mm} + \beta_4 \times \texttt{sex} + \\
&& \beta_5 \times \texttt{species}\\
\end{eqnarray*}
