...
\begin{eqnarray*}
\mbox{Model } A_1 && \widehat{\texttt{age}} = \beta_0 + \beta_1 \times \text{weight}\\
\mbox{Model } A_2 && \widehat{\texttt{age}} = \beta_0 + \beta_1 \times \text{weight}\\
\mbox{Model } A_3 && \widehat{\texttt{age}} = \beta_0 + \beta_1 \times \text{weight}\\
\mbox{Model } A_4 && \widehat{\texttt{age}} = \beta_0 + \beta_1 \times \text{weight}\\
\end{eqnarray*}
