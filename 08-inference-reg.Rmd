...
ggplot(crops2) +
  geom_point(aes(x = maize, y = wheat)) +
  geom_smooth(aes(x = maize, y = wheat), method = "lm", se = FALSE, color="#569BBD") 
```
...
ggplot(crops3) +
  geom_point(aes(x = maize, y = wheat)) +
  geom_smooth(aes(x = maize, y = wheat), method = "lm", se = FALSE,color="#F05133") 
```
...
A careful consideration of the experimental design should be undertaken to confrim that the observed values are indeed independent.
