...
The distribution of slopes (for samples of size $n=20$) can be seen in a histogram, as in Figure \@ref(fig:crops20lm).

```{r crops20lm, echo = FALSE, fig.cap="Variability of slope estimates taken from many different samples, each of size 20."}
