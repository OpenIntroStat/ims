...
1.  **Which is higher?**
Determine if a or b is higher or if they are equal. 
...
The correlation between travel time and distance is 0.636.^[The data used in this exercise can be found in the **openintro** package: [`coast_starlight`](http://openintrostat.github.io/airports/reference/coast_starlight.html).]
