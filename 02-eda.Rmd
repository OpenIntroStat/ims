...
A **box plot** summarizes a data set using five statistics while also plotting unusual observations. Figure \@ref(fig:loan\_int\_rate\_box\_plot\_layout) provides a vertical dot plot alongside a box plot of the `interest_rate` variable from the `loan50` data set.

```{r loan_int_rate_box_plot_layout, eval=FALSE}
d <- loan50$interest_rate

par(mar = c(0, 4, 0, 1), mgp = c(2.8, 0.55, 0))
boxPlot(d,
        ylab = 'Interest Rate',
        xlim = c(0.3, 3),
        axes = FALSE,
