...
We use statistical software for generating the summaries and graphs presented in this chapter and throughout the book.
...
p_stacked <- ggplot(loans_full_schema, aes(x = homeownership, fill = application_type)) +
  geom_bar() +
  scale_fill_manual(values = c(COL[3,1], COL[1,1])) +
...
p_mosaic_1 <- ggplot(loans_full_schema) +
  geom_mosaic(aes(x = product(homeownership)), fill = COL[2,1]) +
