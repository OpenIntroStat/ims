...
::: {.data data-latex=""}
The data can be found in the [**openintro**](http://openintrostat.github.io/openintro) R package: [loans](http://openintrostat.github.io/openintro/reference/loans_full_schema.html).
:::
...
loans %>%
  ...
  kbl(booktabs = TRUE, caption = "A contingency table for application type and homeownership.") %>%
...
loans %>%
  ...
  kbl(booktabs = TRUE, caption = "A table summarizing the frequencies for each value of the homeownership variable: mortgage, own, and rent.") %>%
  kable_styling(bootstrap_options = c("striped", "condensed"), 
                latex_options = c("striped", "hold_position"), full_width = FALSE) %>%
...
loans %>%
  ...
  kbl(booktabs = TRUE, caption = "A contingency table with row proportions for the application type and homeownership variables.") %>%
  kable_styling(bootstrap_options = c("striped", "condensed"), 
                latex_options = c("striped", "hold_position"), full_width = FALSE) %>%
  add_header_above(c(" " = 1, "homeownership" = 3, " " = 1)) %>%
  column_spec(1:5, width = "8em")
...
loans %>%
  ...
  pivot_wider(names_from = homeownership, values_from = proportion) %>% 
  adorn_totals(where = "row") %>% 
  kbl(booktabs = TRUE, caption = "A contingency table with column proportions for the application type and homeownership variables.") %>%
  kable_styling(bootstrap_options = c("striped", "condensed"), 
                latex_options = c("striped", "hold_position"), full_width = FALSE) %>%
...
::: {.data data-latex=""}
The data can be found in the [**openintro**](http://openintrostat.github.io/openintro) R package: [email](http://openintrostat.github.io/openintro/reference/email.html).
:::
...
email %>%
  ...
  adorn_totals(where = c("row", "col")) %>%
  kbl(booktabs = TRUE, caption = "A contingency table for spam and format") 
```
...
```{r loan-waffle, fig.cap = "Plot A: Waffle chart of homeownership, with levels rent, morgage, and own. Plot B: Waffle chart of loan status, with levels current, fully paid, in grade period, and late.", out.width = "100%", fig.asp = 1}
...
county %>%
  ...
  kbl(booktabs = TRUE, caption = "The median household income from a random sample of 5 counties with population gain between 2010 to 2017 and another random sample of 5 counties with no population gain.",
      align = "llccc") %>%
  kable_styling(bootstrap_options = c("striped", "condensed"), 
                latex_options = c("striped", "hold_position"), full_width = FALSE) %>%
