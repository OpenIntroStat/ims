...
::: {.uptohere}
This book is currently in active development, and is planned for launch in late 2020 as the preliminary edition of OpenIntro::Introduction to Modern Statistics. This is a revamped version of OpenIntro::Introduction to Statistics with Randomization and Simulation, the 1st edition of which can be accessed at [openintro.org/book/isrs](https://www.openintro.org/book/isrs/).
::: 
...
Many of these datasets are in the [openintro](http://openintrostat.github.io/openintro) package that contains data sets used in [OpenIntro](https://www.openintro.org/)'s open-source textbooks.^[Mine Çetinkaya-Rundel, David Diez, Andrew Bray, Albert Kim, Ben Baumer, Chester Ismay and Christopher Barr (2020). openintro: Data Sets and Supplemental Functions from 'OpenIntro' Textbooks and Labs. R package version 2.0.0. https://github.com/OpenIntroStat/openintro.] 
