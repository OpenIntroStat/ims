...
This is the online version of the textbook *Introduction to Modern Statistics, First Edition*!
<!--
...
::: {.underconstruction}
First edition is currently under active developlemt.
...
<img src="images/_authors/mine.png" alt="Mine Çetinkaya-Rundel" class="cover" width="150" height="150"/> [Mine Çetinkaya-Rundel](http://mine-cr.com/) <br> [mine\@openintro.org](mailto:mine@openintro.org){.email} <br> University of Edinburgh, Duke University, RStudio <br>
...
<img src="images/_authors/jo.png" alt="Jo Hardin" class="cover" width="150" height="150"/> [Johanna Hardin](https://research.pomona.edu/johardin/) <br> [jo.hardin\@pomona.edu](mailto:jo.hardin@pomona.edu){.email} <br> Pomona College <br>
