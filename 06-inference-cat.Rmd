...
As we build on the inferential ideas, we will visit new foundational concepts in statistical inference like error rates in hypothesis testing and choosing the confidence level for a confidence interval.
```
