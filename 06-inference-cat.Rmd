...
---
  ...
  Figure \@fig(fig:malaria-rand-dot-plot).
...
Use the CPR data.  After we find the CI (use percentile and SE methods), write the interval values down below in the math section that describes the genertic confidence interval method.  The data are provided in Table \@ref(tab:resultsForCPRStudyInSmallSampleSection).
