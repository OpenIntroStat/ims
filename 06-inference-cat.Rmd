...
#### Randomization distribution of the chi-square statisic
...
When analyzing 2-by-2 contingency tables (that is, when both variables only have two possible options), one guideline
