...
#|   The left tail, representing the p-value for the hypothesis test, contains 
#|   `r medical_consultant_p_val*100`% of the simulations.
#| fig-alt: |
...
#|   p-value for the hypothesis test, contains `r medical_consultant_p_val*100`%.
...
::: {.guidedpractice data-latex=""}
Because the estimated p-value is `r medical_consultant_p_val`, which is smaller than the discernibility level 0.05, we reject the null hypothesis.
