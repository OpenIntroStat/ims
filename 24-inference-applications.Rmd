...
"statistic of interest", "proportion: $\\hat{p}$", "diff in proportions: $\\hat{p}_1 - \\hat{p}_2$",
...
zsim_table %>%
 kbl(caption = "Similarities of $z$-methods across one and two independent samples analysis of a binary response variable.", 
...
tsim_table %>%
 kbl(caption = "Similarities of $t$-methods across one sample, paired sample, and two independent samples analysis of a numeric response variable.", 
