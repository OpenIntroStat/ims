...
::: {.workedexample}
Consider a handful of crop yields taken from [Our World in Data](https://ourworldindata.org/crop-yields). In each plot a point represents a different country.  The x and y variables represent the proportion of total yield in the last 50 years which is due to that crop type. 
