...
Examine the residual plots in Figures \@ref(outlierPlots1) and \@ref(outlierPlots2). 
...
If one of these high leverage points does appear to actually invoke its influence on the slope of the line -- as in Plots C, D, and E of Figures \@ref(outlierPlots1) and \@ref(outlierPlots2) -- then we call it an **influential point**. 
