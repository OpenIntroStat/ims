...
The results of the survey by political ideology are shown below.^[The data used in this exercise can be found in the **openintro** package: [`immigration`](http://openintrostat.github.io/openintro/reference/immigration.html).] [@survey:immigFL:2012]
