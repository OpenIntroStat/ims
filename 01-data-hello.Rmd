...
loan50 %>% 
  ...
  slice_head(n = 6) %>%
  kbl(caption = "Six rows from the `loan50` data set",
...
loan50_var_def %>%
  kbl(caption = "Variables and their descriptions for the `loan50` data set.", 
...
county %>%
  ...
  slice_head(n = 6) %>% 
  kbl(caption = "Six observations and six variables from the `county` data set.",
      booktabs = TRUE) %>%
  kable_styling(bootstrap_options = c("striped", "condensed"), 
                latex_options = "striped")
```
...
county_var_def %>%
  kbl(caption = "Variables and their descriptions for the `county` data set.", 
      col.names = c("Variable", "Description")) %>%
  kable_styling(bootstrap_options = c("striped", "condensed"), 
                latex_options = "striped", full_width = TRUE) %>%
  column_spec(1, monospace = TRUE) %>%
