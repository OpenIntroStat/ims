...
loan50 %>% 
  ...
  slice_head(n = 6) %>%
  kbl(booktabs = TRUE, caption = caption_helper("Six observations from the `loan50` data set"),
      row.names = TRUE) %>%
  kable_styling(bootstrap_options = c("striped", "condensed"), 
                latex_options = "striped")
```
...
loan50_var_def %>%
  kbl(booktabs = TRUE, caption = caption_helper("Variables and their descriptions for the `loan50` data set."), 
...
county %>%
  ...
  slice_head(n = 6) %>% 
  kbl(booktabs = TRUE, caption = caption_helper("Six observations and six variables from the `county` data set.")) %>%
  kable_styling(bootstrap_options = c("striped", "condensed"), 
                latex_options = "striped")
```
...
county_var_def <- tribble(
  ...
  "median_edu",        "Median education level (2013-2017), taking one of the values `below\\_hs`, `hs\\_diploma`, `some\\_college`, or `bachelors`.", 
...
county_var_def %>%
  kbl(booktabs = TRUE, caption = caption_helper("Variables and their descriptions for the `county` data set."), 
      col.names = c("Variable", "Description")) %>%
  kable_styling(bootstrap_options = c("striped", "condensed"), 
                latex_options = "striped", full_width = TRUE) %>%
  column_spec(1, monospace = TRUE) %>%
