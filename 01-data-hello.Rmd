...
In this question, we are asking whether one variable effects another.
...
When we suspect one variable might causally effect another, we label the first variable the explanatory variable and the second the response variable.
...
explanatory variable $\rightarrow$ *might effect* $\rightarrow$ response variable
