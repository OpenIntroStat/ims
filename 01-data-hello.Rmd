...
loan50_var_def %>%
  kbl(linesep = "\\addlinespace", booktabs = TRUE, caption = caption_helper("Variables and their descriptions for the `loan50` dataset."), 
...
county_var_def %>%
  kbl(linesep = "\\addlinespace", booktabs = TRUE, caption = caption_helper("Variables and their descriptions for the `county` dataset."), 
      col.names = c("Variable", "Description")) %>%
  kable_styling(bootstrap_options = c("striped", "condensed"), 
                latex_options = c("striped", "hold_position"), full_width = TRUE) %>%
  column_spec(1, monospace = TRUE) %>%
