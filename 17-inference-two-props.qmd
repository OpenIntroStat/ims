...
## Randomization test for the difference in proportions {#sex-two-prop-errors}
...
Reconsider the CPR data from @sec-two-prop-errors which is provided in  @tbl-bpcpr-summary.
