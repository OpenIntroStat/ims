...
histPlot(smoking$amtWeekends, xlab = "Amount Weekends", ylab = "", xlim = c(0,60), axes = FALSE, breaks = 30, col = oiB)
axis(1, seq(0,60,10))
axis(2, seq(0,100,50))

histPlot(smoking$amtWeekdays, xlab = "Amount Weekdays", ylab = "", xlim = c(0,60), axes = FALSE, breaks = 30, col = oiB)
axis(1, seq(0,60,10))
axis(2, seq(0,100,50))
