...
The first four homes are shown in @tbl-duke-data-frame, and descriptions for each variable are shown in @tbl-duke-variables.
...
#| tbl-cap: |
#|   Top four rows of the data describing homes for sale in the 
#|   Duke Forest neighborhood of Durham, NC.
...
#| fig-asp: 1.0
#| fig-cap: |
#|   Scatter plots describing six different predictor variables'
#|   relationship with the price of a home.
#| fig-alt: Six scatter plots where the observations are different homes.
...
#| fig-alt: Residual scatterplot showing predicted sale price on the y axis
#|   and residual on the y axis from the model on square feet only. There is a fan shape showing
...
&+ 41,076 \times \texttt{bath} + 1,459 \times \texttt{year\_built}\\
