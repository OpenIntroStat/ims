...
## Case Study {#basic-stents-strokes}
...
::: {.guidedpractice}
Suppose an observational study tracked sunscreen use and skin cancer, and it was found that the more sunscreen someone used, the more likely the person was to have skin cancer. Does this mean sunscreen *causes* skin cancer?^[No. See the paragraph following :::
...
Further the concepts you've learned in this chapter in R with computational labs that walk you through a data analysis case study.

`r emo::ji("memo")` [Lab 1: Intro to R](http://openintrostat.github.io/oilabs-tidy/01_intro_to_r/intro_to_r.html)

`r emo::ji("computer")` [Full list of labs supporting OpenIntro::Introduction to Modern Statistics](http://openintrostat.github.io/oilabs-tidy/)
