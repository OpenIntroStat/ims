...
```{r countyDF}
county_partial <- county_complete %>%
  select(name, state, pop2010, pop2017, fed_spending_2009, poverty_2017, 
         homeownership_2010, housing_multi_unit_2010, per_capita_income_2017, 
         median_household_income_2016, smoking_ban_2010)
colnames(county_partial) <- c("name", "state", "pop2010", "pop2017", "fed_spend", 
                      "poverty", "homeownership", "multiunit", 
                      "income", "med_income", "smoking_ban")
county_partial <- county_partial %>%
