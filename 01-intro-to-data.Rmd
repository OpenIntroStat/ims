...
Apply the concepts you've learned in this chapter in R using the following self-paced tutorials.
...
If you'd like to apply what you've learned in R, try out the labs...

<link to oilabs-tidy page>

<link to relevant lab page>
