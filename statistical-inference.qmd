...
-   [Chapter -@sec-inference-application] includes an application on the Redundant adjectives case study where the topics from this part of the book on means are fully developed.
