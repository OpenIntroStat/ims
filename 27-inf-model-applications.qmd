...
```{r}
#| label: mariokart-full-model-output
mariokart %>%
...
```{r}
#| label: mariokart-rand-dist
#| fig.cap: (ref:mariokart-rand-dist-cap)
set.seed(47)
mariokart %>%
...
```{r}
#| label: mariokart-boot-dist
#| fig.cap: (ref:mariokart-boot-dist-cap)
set.seed(47)
mariokart %>%
  specify(price ~ cond_new) %>%
...
```{r}
#| label: mariokart-cv-residuals
#| fig.cap: (ref:mariokart-cv-residuals-cap)
#| out.width: 100%
#| fig.width: 8.0
set.seed(4)
...
::: {.content-visible when-format="pdf"} https://openintrostat.github.io/ims-tutorials/06-model-infer
:::
...
::: {.content-visible when-format="pdf"} https://openintro.shinyapps.io/ims-06-model-infer-01
:::
...
::: {.content-visible when-format="pdf"} https://openintro.shinyapps.io/ims-06-model-infer-02
:::
...
::: {.content-visible when-format="pdf"} https://openintro.shinyapps.io/ims-06-model-infer-03
:::
...
::: {.content-visible when-format="pdf"} https://openintro.shinyapps.io/ims-06-model-infer-04
:::
...
::: {.content-visible when-format="pdf"} https://openintro.shinyapps.io/ims-06-model-infer-05
:::
