...
\begin{figure}
\centering
\includegraphics[width=0.65\textwidth]{01/figures/possumHeadVsSkullW/possumHeadVsSkullW}
...
\begin{figure}[bth]
   \centering
   \includegraphics[width=0.7\textwidth]{01/figures/carsPriceHist/carsPriceHist}
...
\centering
\subfigure[]{
\includegraphics[width=0.4\textwidth]{01/figures/typeDriveTrainMosaicPlot/typeDriveTrainMosaicPlotType}
\label{typeDriveTrainMosaicPlotType}
}
\subfigure[]{
\includegraphics[width=0.4\textwidth]{01/figures/typeDriveTrainMosaicPlot/typeDriveTrainMosaicPlotFull}
