...
\end{itemize}
In the end, there were 733 patients in the treatment group and 742 patients in the control group. The patients were not told which group they were in, and the reason for this secrecy is that %patients who know they are not being treated may seek out alternative treatment. Additionally, 
...
%\begin{exercise}
%How many patients were in the treatment group and lived? Answer in the footnote\footnote{Identify where the \resp{treatment} row and the \resp{lived} column intersect: 692.}.
%\end{exercise}
...
%\begin{exercise}
%Examine again Table~\ref{sulphinpyrazoneResultsInIntro}. How many patients are there in the control group? What proportion of them died? \footnote{742 patients were in the control group, and $60/742=0.081$ (8.1\%) of them died.}
%\end{exercise}
...
Table~\ref{carsDF} displays rows
\begin{table}
\begin{center}
