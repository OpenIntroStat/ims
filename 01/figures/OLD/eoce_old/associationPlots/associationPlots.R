...
plot(y_poslin ~ x, yaxt = "n", xaxt = "n", xlab = "(1)", ylab = "", cex.lab = 1.75, pch=20, col=COL)

plot(y_none ~ x, yaxt = "n", xaxt = "n", xlab = "(2)", ylab = "", cex.lab = 1.75, pch=20, col=COL)

plot(y_poscur ~ x, yaxt = "n", xaxt = "n", xlab = "(3)", ylab = "", cex.lab = 1.75, pch=20, col=COL)

plot(y_neglin ~ x, yaxt = "n", xaxt = "n", xlab = "(4)", ylab = "", cex.lab = 1.75, pch=20, col=COL)
