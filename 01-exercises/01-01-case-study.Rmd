...
1.  **Migraine and acupuncture, Part I.** 
...
1.  **Sinusitis and antibiotics, Part I.** 
...
The distribution of responses is summarized below.^[The data used in this exercise can be found in the **openintro** package: [`sinusitis`](http://openintrostat.github.io/openintro/reference/sinusitis.html).] [@Garbutt:2012]
    ...
    d.  Your findings so far might suggest that a real difference in effectiveness of antibiotic and placebo treatments for improving symptoms of sinusitis. However this is not the only possible conclusion that can be drawn based on your findings so far. What is one other possible explanation for the observed difference between the percentages of patients that are pain free 24 hours after receiving acupuncture in the two groups?
