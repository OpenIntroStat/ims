...
24 hours after patients received acupuncture, they were asked if they were pain free. What are the explanatory and response variables in this study?^[The data used in this exercise can be found in the **openintro** package: [`migraine`](http://openintrostat.github.io/openintro/reference/migraine.html).] [@Allais:2011]
...
At the end of the 10-day period, patients were asked if they experienced improvement in symptoms. What are the explanatory and response variables in this study?^[The data used in this exercise can be found in the **openintro** package: [`sinusitis`](http://openintrostat.github.io/openintro/reference/sinusitis.html).] [@Garbutt:2012]
