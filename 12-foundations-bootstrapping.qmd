...
```{r}
#| label: boot1
#| fig.cap: The unknown population is estimated using the observed sample data.  Note
...
#| warning: false
#| out.width: 75%
#| fig.alt: A small sample of 3 red marbles and 4 white marbles is taken from a large
#|   population with predominately unknown individual values.  The sample is then replicated
#|   infinitely many times to create a proxy population where the values are known to
#|   be 3/7 red and 4/7 white.
...
```{r}
#| label: boot2
#| fig.cap: Bootstrap sampling provides a measure of the sample to sample variability.  Note
#|   that we are taking samples from the estimated population that was created from the
#|   observed data.
#| out.width: 75%
#| fig.alt: 'The same unknown large population is given with a sample of 3 red and 4
...
```{r}
#| label: boot3
#| fig.cap: The bootstrapped proportion is estimated for each bootstrap sample.  The
#|   resulting bootstrap distribution (dotplot) provides a measure for how the proportions
#|   vary from sample to sample
#| warning: false
#| out.width: 95%
#| fig.alt: The same unknown large population with a sample of 3 red and 4 white marbles;
...
```{r}
#| label: tappers-bs-sim
#| fig.cap: (ref:tappers-bs-sim-cap)
bsprop_tap <- tibble(
...
```{r}
#| label: bootboth
#| fig.cap: We will use sampling with replacement to measure the variability of the statistic
