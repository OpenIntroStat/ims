...
mlb_players_18 %>%
  ...
  slice_head(n = 6) %>%
  kbl(booktabs = TRUE, caption = caption_helper("Six cases and some of the variables from the `mlb_players_18` data frame."), align = "lllrrrrrr") %>%
...
mlb_players_18_vars %>%
  kbl(booktabs = TRUE, caption = caption_helper("Variables and their descriptions for the `mlb_players_18` data set."), 
