...
mlb_players_18 %>%
  ...
  head(6) %>%
  kbl(caption = "Six cases and some of the variables from the `mlb_players_18` data frame.") %>%
  kable_styling()
```
...
temptbl %>%
  kbl(caption = "Variables and their descriptions for the mlb_players_18 data set.", col.names = c( "variable", "description")) %>%
