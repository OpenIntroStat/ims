...
```{r single-scatter, out.width = "100%", fig.asp = 1, fig.cap = "Scatter plots describing six different predictor variables' relationship with the price of a home."}
...
::: {workedexample data-latex=""} Using Table \@ref(tab:price-mlr), write out the linear model of price on the six predictor variables.
