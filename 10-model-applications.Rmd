...
A friend suggests that maybe you don't need all six variables to have a good model for `price`.
...
[Intro to data - Human Freedom Index](https://www.openintro.org/go?id=ims-r-lab-model)\
```{asis, echo = knitr::is_latex_output()}
