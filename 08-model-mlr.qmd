...
The first six observations in the dataset are shown in @tbl-loans-data-matrix, and descriptions for each variable are shown in @tbl-loans-variables.
...
#|   on whether the borrower’s income source and amount has been 
