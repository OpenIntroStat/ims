...
#| fig-alt: |
#|   Boxplots of the tire tread data (in cm) and the brand of tire from which
#|   the original measurements came. The boxplots are overlaid with the
#|   individual measurements and labeled with the mean tread amount for each 
#|   brand of tire: 0.308 for Quick Spin and 0.310 for Smooth Turn.
...
A portion of the dataset from these courses is shown in @fig-textbooksDF, where prices are in US dollars.
