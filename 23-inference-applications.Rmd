...
-   Compute the proportion of times the permuted statistics are more extreme than the observed statistic, this is the p-value.
...
-   Repeatedly resample the original data, with replacement.\
...
-   Bootstrap SE interval: find the SE of the bootstrapped statistics. The confidence interval will be given by the original observed statistic plus or minus some multiple (e.g., 2) of SE, using the formula: point estimate $\pm\ z^{\star} SE.$\
