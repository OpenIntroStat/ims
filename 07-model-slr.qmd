...
First, the data all come from one first-year class, and the way aid is determined by the university may change from year to year.
...
```{r}
#| include: false
terms_chp_07 <- c(terms_chp_07, "total sum of squares", "sum of squared error")
```
