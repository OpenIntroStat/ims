...
histPlot(bscars_sd, breaks = breaks, axes = FALSE, col = rgb(1,1,1),
     xlab = "", ylab="")
#histPlot(bsmeans_up, breaks = breaks, col = openintro_cols("blue"), add = TRUE)
#histPlot(bsmeans_low, breaks = breaks, col = openintro_cols("blue"), add = TRUE)
axis(1)
...
COL. <- fadeColor(openintro_cols("blue"), c("FF", "89", "68", "4C", "33"))
COLt <- fadeColor(openintro_cols("blue"), c("FF", "AA", "85", "60", "45"))
DF   <- c('normal', 8, 4, 2, 1)
