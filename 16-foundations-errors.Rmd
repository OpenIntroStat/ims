...
```{r include=FALSE}
terms_chp_16 <- c("type 1 error", "type 2 error")
```
...
```{r include=FALSE}
terms_chp_16 <- c(terms_chp_16, "significance level")
```
...
```{r include=FALSE}
terms_chp_16 <- c(terms_chp_16, "confirmation bias", "one-sided hypothesis test", 
...
```{r include=FALSE}
terms_chp_16 <- c(terms_chp_16, "null distribution")
```
...
```{r include=FALSE}
terms_chp_16 <- c(terms_chp_16, "power")
```
