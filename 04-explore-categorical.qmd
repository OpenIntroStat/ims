...
#|   highest proportion have a home mortgage.  The next highest
...
#|   and application type variables.  There are two or three times
...
#| fig-alt: A pie chart and bar plot of homeownership.
#| fig.width: 8.0
p_pie <- loans |> 
