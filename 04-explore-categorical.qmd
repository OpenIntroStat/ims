...
What does 0.802 represent in Table \@ref(tab:loan-home-app-type-column-proportions)?[^04-explore-categorical-1]
:::
...
What does 0.135 represent in Table \@ref(tab:loan-home-app-type-column-proportions)?[^04-explore-categorical-2]
:::
...
::: {.guidedpractice data-latex=""}
What components of each plot in Figure \@ref(fig:countyIncomeSplitByPopGain) do you find most useful?[^04-explore-categorical-4]
:::
...
::: {.guidedpractice data-latex=""}
What components of the ridge plot in Figure \@ref(fig:countyIncomeSplitByPopGainRidge) do you find most useful compared to those in Figure \@ref(fig:countyIncomeSplitByPopGain)?[^04-explore-categorical-5]
:::
...
::: {.guidedpractice data-latex=""}
Based on Figure \@ref(fig:countyIncomeRidgeMulti), what can you say about how median household income in counties vary depending on population gain/no gain, metropolitan area/not, and median degree?[^04-explore-categorical-6]
:::
