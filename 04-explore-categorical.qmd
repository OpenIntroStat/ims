...
```{r}
#| label: loan-home-app-type-totals
loans %>%
...
```{r}
#| label: loan-homeownership-totals
loans %>%
...
```{r}
#| label: loan-homeownership-bar-plot
...
```{r}
#| label: loan-homeownership-app-type-bar-plot
...
```{r}
#| label: loan-homeownership-type-mosaic-plot
#| fig.cap: 'The mosaic plots: one for homeownership alone and the other displaying the
...
```{r}
#| label: loan-app-type-mosaic-plot
...
```{r}
#| label: loan-home-app-type-row-proportions
#| out.width: 70%
loans %>%
  count(application_type, homeownership) %>% 
...
```{r}
#| label: loan-home-app-type-column-proportions
loans %>%
  count(application_type, homeownership) %>% 
...
```{r}
#| label: loan-homeownership-pie-chart
...
#|   Plot B: Waffle chart of loan status, with levels current, fully paid, in grade period,
#|   and late.'
#| fig.asp: 0.5
#| fig.width: 8.0
...
```{r}
#| label: countyIncomeSplitByPopGainRidge
...
```{r}
#| label: countyIncomeSplitByPopGainFacetHist
