...
#massCV1 %>%
# mutate(error2 = (obs - predicted)^2) %>%
# summarize(sum(error2)) %>% pull() %>% format(scientific = FALSE) 
...
As evidenced by visually comparing the two sets of residual plots, the sum of squared prediction errors is smaller for the model which uses more predictor variables.
