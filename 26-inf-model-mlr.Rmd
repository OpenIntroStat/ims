...
The $b_1 = 0.13$ coefficient is highly significant, suggesting we would not have seen data like this if `number of coins` and `total_amount` of money were not linearly related.
...
The $b_1 = 0.02$ coefficient is not at all significant, suggesting we could easily have seen data like ours even if the `number of low coins` and `total_amount` of money are not at all linearly related.
