...
$$
\begin{align*}
\widehat{\texttt{interest_rate}} = 4.31 &+ 0.041 \times \texttt{debt_to_income} + 0.16 \times \texttt{term}\\
...
::: {.important}
**Multicollinearity.** Multicollinearity happens when the predictor variables are correlated within themselves.
...
::: {.important}
**Prediction Error.** The predicted error (also previously called the **residual**) is the difference between the observed value and the predicted value (from the regression model).
