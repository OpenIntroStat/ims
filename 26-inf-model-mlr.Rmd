...
lm(interest_rate ~ debt_to_income + term + credit_checks, data = loans) %>%
  ...
  kbl(caption = "Summary of a linear model for predicting interest rate based on the variables debt_to_income, term, and credit_checks. Each of the variables has its own coefficient estimate as well as p-value significance.") %>%
...
include_graphics("images/lowsame.png")
```
:::
...
include_graphics("images/totalsame.png")
```
:::
