...
Maybe it plays a similar role to the "t-procedures" chapter??
Should we make this bit its own chapter?
Or maybe each of the "applications" should have a summary which is like a chapter summary from before?
I like summaries.
:::

In this part, we have provided three different methods for statistical inference.
