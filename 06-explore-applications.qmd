...
#| fig.show: hold
#| fig.ncol: 2.0
#| fig.cap: A pie chart (with added irrelevant features) as compared to a simple bar
#|   plot.
...
::: {.content-visible when-format="pdf"} https://openintrostat.github.io/ims-tutorials/02-explore
:::
...
::: {.content-visible when-format="pdf"} https://openintro.shinyapps.io/ims-02-explore-01
:::
...
::: {.content-visible when-format="pdf"} https://openintro.shinyapps.io/ims-02-explore-02
:::
...
::: {.content-visible when-format="pdf"} https://openintro.shinyapps.io/ims-02-explore-03
:::
...
::: {.content-visible when-format="pdf"} https://openintro.shinyapps.io/ims-02-explore-04
:::
