...
```{r tiredataPermSort, fig.cap = "The brand of tire from which the original measurements came, (left) shuffled brand assignment, (right) sorted by randomized brand.", out.width = "100%"}
...
```{r pairRandomiz, fig.cap = "Histogram of 1000 average differences with tire brand randomly assigned across the two observations (in cm) per pair."}
