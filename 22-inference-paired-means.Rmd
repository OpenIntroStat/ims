...
::: {.data data-latex=""}
The data can be found in the [**openintro**](http://openintrostat.github.io/openintro) R package: [`ucla_textbooks_f18`](http://openintrostat.github.io/openintro/reference/ucla_textbooks_f18.html).
:::
...
ucla_textbooks_f18 %>% 
  ...
  head(4) %>%
  kbl(booktabs = TRUE, caption = caption_helper("Four cases from the `ucla_textbooks_f18` dataset.")) %>%
  kable_styling(bootstrap_options = c("striped", "condensed"), 
...
ucla_textbooks_f18 %>%
  ...
  kbl(booktabs = TRUE, caption = "Summary statistics for the 68 price differences.",
