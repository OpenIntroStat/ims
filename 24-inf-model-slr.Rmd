...
```{r include=FALSE}
terms_chp_24 <- c(termps_chp_24, "variability of the slope")
```
...
```{r include=FALSE}
terms_chp_24 <- c(termps_chp_24, "randomization test for the slope")
```
...
```{r include=FALSE}
terms_chp_24 <- c(termps_chp_24, "bootstrap CI for the slope")
```
...
```{r include=FALSE}
terms_chp_24 <- c(termps_chp_24, "t-distribution for slope")
```
...
```{r include=FALSE}
terms_chp_24 <- c(termps_chp_24, "techinical conditions linear regression")
```
