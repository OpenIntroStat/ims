...
#| fig-cap: A scatterplot of loan amount versus total income for the `loan50` 
#|   dataset.
...
#| fig-cap: A scatterplot of the median household income against the poverty 
...
#| fig-cap: A dot plot of interest rate for the `loan50` dataset. The rates 
...
#| fig-cap: A histogram of interest rate. This distribution is strongly skewed 
#|   to the right.
ggplot(loan50, aes(x = interest_rate)) +
...
#| fig-cap: For the interest rate variable, 34 of the 50 loans (68%) had 
...
#| fig-cap: Plot A shows a dot plot and Plot B shows a box plot of the 
...
#|   change as the value of an extereme observation from the original interest 
#|   data changes.
