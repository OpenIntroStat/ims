...
ggplot(loan50, aes(x = interest_rate)) +
  ...
  geom_polygon(
    data = data.frame(
      x = c(loan50_interest_rate_mean - 1, loan50_interest_rate_mean + 1, loan50_interest_rate_mean),
      y = c(-0.1, -0.1, 0)
    ),
    aes(x = x, y = y),
...
#| fig-alt: Two plots showing the same variable, interests rates.  The top image is a dot plot, the bottom image is a box plot.  Both images re-establish that the distribution of interest rates are right skewed.
#| fig-asp: 0.5
