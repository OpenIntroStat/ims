...
method_summary_table <- tribble(
  ...
  "What other random processes can be approximated?", "Yes, can be used to describe random sampling in an observational model", "Yes, can be used to describe random allocation in an experiment", "Yes",
...
```{r opportunity-cost-rand-dot-plot, fig.cap = "A stacked dot plot of 1,000 simulated differences produced under the null hypothesis, $H_0$. Six of the 1,000 simulations had a difference of at least 20% , which was the difference observed in the study.", out.width = "100%"}
ggplot(opportunity_cost_rand_dist, aes(x = stat)) +
  ...
  labs(
    x = "Simulated differences in proportions of students who\ndo not buy the video (treatment - control)",
    y = NULL
  )
```
...
```{r opportunity-cost-rand-hist, fig.cap = "A histogram of 1,000 chance differences produced under the null hypothesis, $H_0$. Histograms like this one are a more convenient representation of data or results when there are a large number of observations.", out.width = "100%"}
ggplot(opportunity_cost_rand_dist, aes(x = stat)) +
