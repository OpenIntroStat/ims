...
```{r twoSampleNormalsStacked, fig.cap="The two normal models shown in the Figures \@ref(fig:twoSampleNormals) but plotted together on the same scale.", fig.width=10}
# curve 1
X <- seq(-4,4,0.01)
Y <- dnorm(X)
