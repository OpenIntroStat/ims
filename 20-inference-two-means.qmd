...
#|   version A is 74.25 and the average score for version B is 78.2, a difference of -3.95.
...
@fig-bootexamsci displays the variability of the differences in means with the 90% percentile and SE CIs super imposed.
...
#|   boostrap SE confidence intervals, respectively, for the difference in true population
#|   means.
#| fig-alt: |
#|   Histogram of differences in means after 1,000 bootstrap samples from each
#|   of the two groups. The observed difference is plotted as a black vertical line at
...
The p-value is much smaller than the discernibility level, 0.05, so we reject the null hypothesis.
