...
If two variables are not associated, then they are said to be **independent**\index{independence}.
...
If this is our underlying belief, then *median household income* is the **explanatory variable**\index{explanatory variable}, and the *population change* is the **response variable**\index{response variable} in the hypothesized relationship.[^01-data-hello-7]
...
When researchers want to evaluate the effect of particular traits, treatments, or conditions, they conduct an **experiment**\index{study!experiment}.
...
When individuals are randomly assigned to a group, the experiment is called a **randomized experiment**\index{study!randomized experiment}.
...
Researchers perform an **observational study**\index{study!observational} when they collect data in a way that does not directly interfere with how the data arise.
For instance, researchers may collect information via surveys, review medical or company records, or follow a **cohort**\index{cohort} of many similar individuals to form hypotheses about why certain diseases might develop.
