...
```{r}
#| label: stentStudyResultsDFsummary
stent %>%
...
```{r}
#| label: county-multi-unit-homeownership
...
```{r}
#| label: county-pop-change-med-hh-income
