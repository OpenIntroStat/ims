...
## Comparing many means with ANOVA (special topic, include simulation version) {#anovaAndRegrWithCategoricalVariables}
...
### Comparison of many means: randomization test
...
### Comparison of many means: mathematical model
