...
The observed data represent 25 tread measurements taken on 25 tires of Brand A and 25 tires of Brand B.  But the key to this example is taht the 


```{r}
# inches  about 1/32" per 3500 mi
set.seed(47)
brandA <- rnorm(25, .001, .0003)
brandB <- rnorm(25, .0008, .0003)
