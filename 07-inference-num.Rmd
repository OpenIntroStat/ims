...
Find and interpret the confidence interval for $\mu$ (the true average cost of a car at Awesome Auto) using the bootstrap SE confidence interval formula.^[Using the formula for the bootstrap SE interval, we find the 95% confidence interval for $\mu$ is: $17,320 \pm 2 \cdot 1,768.97 \rightarrow$ ($13,782.06, $20,857.94).  We are 95% confident that the true average car price at Awesome Auto is somewhere between $13,782.06 and $20,857.94.]
::: 
