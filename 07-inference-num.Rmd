...
```{r carsbsmean, fig.cap="The original Awesome Auto data is bootstrapped 1,000 times. The histogram provides a sense for the variability of the average car price from sample to sample.", warning=FALSE, fig.width=12}
...
```{r flatsbssd, fig.cap="The original Awesome Auto data is bootstrapped 1,000 times. The histogram provides a sense for the variability of the standard deviation of the car prices from sample to sample.", warning=FALSE, fig.width=12}
...
```{r tiredata4, fig.cap = "The 4th car. The tire brand was randomly permuted, and in the randomization calculation, the measurements ended up in different groups.", warning = FALSE, fig.width=10}
...
ggplot(aes( x = `Tire Brand`, y = tread, color = `Randomized Brand`)) +
 # geom_boxplot() +
  ...
  xlab("Brand of tires.") +
  geom_text(aes(label = car), hjust = rep(c(1.3, -.15), each = 1)) +
  ggtitle("Wear of tire tread (in inches) after 1,000 miles,\n colored by randomized tire brands, plotted by original brand.")
...
ggplot(aes( x = `Randomized Brand`, y = tread, color = `Randomized Brand`)) +
 # geom_boxplot() +
  ...
  xlab("Brand of tires.") +
  geom_text(aes(label = car), hjust = rep(c(1.3, -.15), each = 1)) +
  ggtitle("Wear of tire tread (in inches) after 1,000 miles,\n colored and plotted by randomized tire brands.")
...
```{r tiredata5, fig.cap = "The 5th car. The tire brand was randomly permuted to stay the same! In the randomization calculation, the measurements ended up in the original groups.", warning = FALSE, fig.width=10}
# inches  about 1/32" per 3500 mi
set.seed(47)
brandA <- rnorm(25, .310, .003)
brandB <- rnorm(25, .308, .003)
