...
```{r brexit-bars, fig.cap = "Bar plot three different ways. Plot A: Alphabetic ordering of levels, Plot: Bars ordered in descending order of frequency, Plot C: Bars ordered in the same order as they were presented in the survey question.", fig.width = 11, out.width = "100%"}
...
While the quantitative information in the two graphics is identical, rotating the graph and creating horizontal bars provides more space for the **axis labels**.
The easier the categories are to read, the easier a time the reader will have understanding the visualization.
Remember, the goal is to convey as much information as possible in a succinct and clear manner.

```{r brexit-region, fig.cap = "Segmented bar plots vertically and horizontally. The horizontal orientation makes the region labels easier to read.", fig.width = 10, out.width = "100%"}
brexit <- brexit %>%
  mutate(
    region = fct_relevel(
      region,
