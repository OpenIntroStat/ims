...
```{r brexit-region, fig.cap = "Stacked bar plots vertically and horizontally. The horizontal orientation makes the region labels easier to read.", fig.width = 10, out.width = "100%"}
brexit <- brexit %>%
  mutate(
    region = fct_relevel(
      region,
