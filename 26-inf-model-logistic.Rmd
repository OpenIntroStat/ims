...
We introduce cross validation as a method for independent assessment of the logistic model.
:::

```{r include=FALSE}
terms_chp_26 <- c("inference on logistic model")
```
...
```{r include=FALSE}
terms_chp_26 <- c(terms_chp_26, "cross validation")
```
