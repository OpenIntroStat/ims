...
```{r}
#| label: blue-triangle-shapes
#| fig.cap: Two sets of four shapes. In A, the circled triangle is the only triangle.
#|   In B, the circled triangle is the only blue triangle.
#| fig.alt: 'Four shapes are presented twice.  In A (the top presentation) the shapes
#|   and colors are all different: pink circle, yellow square, red diamond, blue triangle.  In
#|   B (the bottom presentation) the colors are all different but the traingle shape
#|   is repeated: pink circle, yellow square, red triangle, blue triangle.  In each of
#|   the two presentations the blue triangle is circled.'
shape_names <- c(
  "circle filled",
  "square filled", 
  "diamond filled", 
...
#| fig.alt: Two presentations of shapes. In each presentation all of the shapes and their
...
```{r}
#| label: reduntant-bar
#| fig.cap: Results of redundant adjective usage experiment from [@rubio-fernandez2021].
...
```{r}
#| label: boot-eng-4-viz
#| fig.cap: (ref:boot-eng-4-viz-cap)
boot_eng_4 %>%
  ggplot(aes(x = stat)) +
...
```{r}
#| label: eng-viz
#| fig.cap: Distribution of 1,000 mean differences of redundant adjective usage percentage
...
```{r}
#| label: compare-lang-viz
#| fig.cap: Distributions of 1,000 differences in randomized means of redundant adjective
#|   usage percentage between English and Spanish speakers. Plot A shows the differences
#|   in 4 item displays and Plot B shows the differences in 16 item displays. In each
#|   plot, the observed differences in the sample (solid line) as well as the differences
#|   in the other direction (dashed line) are overlaid.
#| fig.asp: 1.0
p_4 <- null_4 %>%
  ggplot(aes(x = stat)) +
  geom_histogram(binwidth = 5, fill = IMSCOL["green", "full"]) +
...
::: {.content-visible when-format="pdf"} https://openintrostat.github.io/ims-tutorials/05-infer
:::
...
::: {.content-visible when-format="pdf"} https://openintro.shinyapps.io/ims-05-infer-01
:::
...
::: {.content-visible when-format="pdf"} https://openintro.shinyapps.io/ims-05-infer-02
:::
...
::: {.content-visible when-format="pdf"} https://openintro.shinyapps.io/ims-05-infer-03
:::
...
::: {.content-visible when-format="pdf"} https://openintro.shinyapps.io/ims-05-infer-04
:::
...
::: {.content-visible when-format="pdf"} https://openintro.shinyapps.io/ims-05-infer-05
:::
...
::: {.content-visible when-format="pdf"} https://openintro.shinyapps.io/ims-05-infer-06
:::
...
::: {.content-visible when-format="pdf"} https://openintro.shinyapps.io/ims-05-infer-07
:::
...
::: {.content-visible when-format="pdf"} https://openintro.shinyapps.io/ims-05-infer-08
:::
...
::: {.content-visible when-format="pdf"} https://www.openintro.org/go?i
d=ims-r-lab-infer-1
:::
