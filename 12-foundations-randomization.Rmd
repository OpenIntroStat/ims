...
```{r opportunity-cost-obs-bar, fig.cap = "Segmented bar plot of results of the opportunity cost study.", out.width = "100%", fig.asp = 0.3}
...
```{r opportunity-cost-rand-dot-plot, fig.cap="(ref:opportunity-cost-rand-dot-plot-cap)", out.width = "100%"}
...
```{r opportunity-cost-rand-hist, fig.cap = "A histogram of 1,000 chance differences produced under the null hypothesis. Histograms like this one are a convenient representation of data or results when there are a large number of simulations.", out.width = "100%"}
ggplot(opportunity_cost_rand_dist, aes(x = stat)) +
