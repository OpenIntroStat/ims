...
#|   mother's age. Notice that the relationship between mother's age and weight of baby 
...
#| fig-cap: The original births data on baby's weight and mother's age is bootstrapped 1,000 times. The histogram provides a sense for the variability of the slope of the linear model from sample to sample.
