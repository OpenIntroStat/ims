...
Because the focus here is *not* on a null distribution, sample with replacement $n=100$ observations from the original dataset.
...
#|   panel: a time series dataset is shown, where successive observations are highly
#|   correlated.'
