...
#|   A linear model is superimposed. The points show a reasonably strong and positive linear trend.
set.seed(4747)
popsize <- 1000
...
#| fig-cap: |
#|   A random sample of 20 stores from the entire population. A linear trend between
...
#| fig-cap: |
#|   A different random sample of 20 stores from the entire population. Again,
#|   a linear trend between advertising and revenue is observed.
#| fig-alt: |
#|   For a random sample of 20 stores, scatterplot with advertising amount on the 
...
#| label: fig-sand20lm
#| fig-cap: |
#|   Variability of slope estimates taken from many different samples of stores,
#|   each of size 20.
#| fig-alt: |
...
#| fig-cap: |
#|   Two different permutations of the `weight` variable with slightly 
...
#| label: fig-birth2BS
#| fig-cap: |
#|   Original and one bootstrap sample of the births data. Note that it is difficult
