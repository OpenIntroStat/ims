...
Since we wouldn't expect the sample proportions to be *exactly* equal, even if the truth was that the promotion decisions were independent of sex, we cannot rule out random chance as a possible explanation when simply comparing the sample proportions.
:::
