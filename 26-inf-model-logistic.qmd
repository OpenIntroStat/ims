...
#|   model on 3/4 of the dataset with a single predictor variable. Predictions 
#|   are made on the remaining 1/4 of the observations. Note that the predictions 
#|   are independent of the estimated model coefficients, and the prediction 
...
#|   spam emails, 80 were correctly classified as spam. Of the 897 non-spam emails, 
#|   143 were correctly classified as not spam.
#| out-width: 100%
