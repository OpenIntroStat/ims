...
#| fig-cap: |
#|   Both curves represent the normal distribution, however, they differ in 
#|   their center and spread. The normal distribution with mean 0 and standard
#|   deviation 1 (blue solid line, on the left) is called the 
#|   **standard normal distribution**. The other distribution (green dashed 
#|   line, on the right) has mean 19 and standard deviation 4.
#| fig-alt: |
#|   Two normal curves. The first one has a mean at zero
