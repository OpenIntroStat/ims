...
#| fig.cap: The null distribution for each of the four case studies presented previously.
...
#| fig.cap: Both curves represent the normal distribution, however, they differ in their
#|   center and spread. The normal distribution with mean 0 and standard deviation 1
#|   (blue solid line, on the left) is called the **standard normal distribution**. The
#|   other distribution (green dashed line, on the right) has mean 19 and standard deviation
#|   4.
#| fig-asp: 0.3
#| out.width: 100%
normals <- tibble(
...
#| fig.cap: (ref:twoSampleNormalsStacked-cap)
#| fig-asp: 0.3
#| out.width: 100%
...
```{r}
#| label: satBelow1800
#| fig.cap: The normal model for SAT scores, shading the area of those individuals who
#|   scored below Nel.
#| fig-asp: 0.5
#| out.width: 60%
...
```{r}
#| label: subtractingArea
#| fig.cap: Visual calculation of the probability that Shannon scores at least 1630 on
#|   the SAT.
...
```{r}
#| label: er6895997
#| fig.cap: Probabilities for falling within 1, 2, and 3 standard deviations of the mean
...
#| fig.cap: Null distribution of differences with an overlaid normal curve for the opportunity
#|   cost study. 10,000 simulations were run for this figure.
...
```{r}
#| label: MedConsNullSim-w-normal
#| fig.cap: The null distribution for the sample proportion, created from 10,000 simulated
#|   studies, along with the best-fitting normal model.
...
#| fig.cap: Twenty-five samples of size $n=300$ were collected from a population with
