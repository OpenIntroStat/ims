...
#| fig.cap: Side-by-side box plot of the on-base percentage for 429 players across three
#|   groups. There is one prominent outlier visible in the infield group, but with 205
#|   observations in the infield group, this outlier is not extreme enough to have an
...
```{r}
#| label: summaryStatsForThreeVersionsOfExams
classdata <- classdata %>%
...
```{r}
#| label: boxplotThreeVersionsOfExams
...
```{r}
#| label: rand3examspval
#| fig.cap: Histogram of F statistics calculated from 1000 different randomizations of
#|   the exam type. The observed F statistic is given as a red vertical line 3.48.  The
