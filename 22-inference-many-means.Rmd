...
To understand this better, let us consider a slightly different problem.
...
If we select only these classes that look so different and then perform a formal test, we will probably make the wrong conclusion that the assignment was not random.
...
It should not matter whether they were given exam A or exam B or exam C.
