...
loans %>%
  slice_head(n = 6) %>%
  kbl(booktabs = TRUE, caption = caption_helper("First six rows of the `loans` data set.")) %>%
...
loans_var_def %>%
  ...
  kbl(booktabs = TRUE, caption = caption_helper("Variables and their descriptions for the `loans` data set."), 
