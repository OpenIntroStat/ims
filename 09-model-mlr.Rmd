...
loans_var_def %>%
  kbl(linesep = "", booktabs = TRUE, caption = caption_helper("Variables and their descriptions for the `loans` dataset."), 
...
m_full_w_rsq %>%
  kbl(linesep = "", booktabs = TRUE, caption = "The fit for the full regression model, including the adjusted $R^2$.", digits = 2, align = "lrrrr")  %>%
  kable_styling(bootstrap_options = c("striped", "condensed"), 
                latex_options = c("striped", "hold_position")) %>%
