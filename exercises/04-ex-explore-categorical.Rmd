...
The results of the survey by political ideology are shown below.^[The data used in this exercise can be found in the **openintro** R package: [`immigration`](http://openintrostat.github.io/openintro/reference/immigration.html).]
...
The results are summarized in the stacked bar plot below.
    ...
    b. Conjecture other possible variables that might explain the potential relationship between these two variables.
