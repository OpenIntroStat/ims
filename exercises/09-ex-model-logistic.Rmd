1. **True / False.**
Determine which of the following statements is true and false. If false, explain why.
"In logistic regression we fit a line to model the relationship between the predictor(s) and the binary outcome."
