...
1. \(a) $\widehat{\texttt{weight}} = 7.270 - 0.593 \times \texttt{habit}_\texttt{smoker}$. (b) The estimated body weight of babies born to smoking mothers is 0.593 ounds lower than those who are born to non-smoking mothers. Smoker: $\widehat{\texttt{weight}} = 7.270 - 0.593 \times 1  = 6.68$ pounds. Non-smoker: $\widehat{\texttt{weight}} = 7.270 - 0.593 \times 0 = 7.270$ pounds.
\addtocounter{enumi}{1}
