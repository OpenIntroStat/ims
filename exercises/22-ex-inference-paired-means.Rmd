...
The bootstrap distribution below was produced by bootstrapping from the sample of differences in reading and writing scores 1,000 times.
    ...
    a.  Find an approximate 95% confidence interval for the true average difference in scores (read - write).

    b.  Interpret the confidence interval using words like "population" and "score".

    c.  From the confidence interval calculated above, does it appear that there is a significant difference in reading and writing scores, on average?
