...
A scatterplot of life span versus length of gestation is shown below.^[The [`mammals`](http://openintrostat.github.io/openintro/reference/mammals.html) data used in this exercise can be found in the **openintro** R package.] [@Allison+Cicchetti:1975]
...
The relative frequency histogram below shows the distribution of estimated infant death rates for 224 countries for which such data were available in 2014.^[The [`cia_factbook`](http://openintrostat.github.io/openintro/reference/cia_factbook.html) data used in this exercise can be found in the **openintro** R package.]
...
AQI was reported for a sample of 91 days in 2011 in Durham, NC. The histogram below shows the distribution of the AQI values on these days.^[The [`pm25_2011_durham`](http://openintrostat.github.io/openintro/reference/pm25_2011_durham.html) data used in this exercise can be found in the **openintro** R package.]
...
Summary statistics for these distributions are also provided. Compare the distributions of ages of best actor and actress winners.^[The [`oscars`](http://openintrostat.github.io/openintro/reference/oscars.html) data used in this exercise can be found in the **openintro** R package.]
...
Also shown below is a spatial intensity map of the same data.^[The [`county_complete`](http://openintrostat.github.io/openintro/reference/county_complete.html) data used in this exercise can be found in the **usdata** R package.]
