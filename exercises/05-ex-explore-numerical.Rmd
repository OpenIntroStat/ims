...
A scatterplot of life span versus length of gestation is shown below.^[The data used in this exercise can be found in the **openintro** R package: [`mammals`](http://openintrostat.github.io/openintro/reference/mammals.html).] [@Allison+Cicchetti:1975]
...
The histogram below shows the distribution of the AQI values on these days.^[The data used in this exercise can be found in the **openintro** R package: [`pm25_2011_durham`](http://openintrostat.github.io/openintro/reference/pm25_2011_durham.html).]
...
Summary statistics for these distributions are also provided. Compare the distributions of ages of best actor and actress winners.^[The data used in this exercise can be found in the **openintro** R package: [`oscars`](http://openintrostat.github.io/openintro/reference/oscars.html).]
...
Also shown below is a spatial intensity map of the same data.^[The data used in this exercise can be found in the **usdata** R package: [`county_complete`](http://openintrostat.github.io/openintro/reference/county_complete.html).]
