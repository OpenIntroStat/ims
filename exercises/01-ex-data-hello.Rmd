...
Also provided is a figure from the original paper displaying the appropriate area (M) versus the inappropriate area (S) used in the treatment of migraine attacks.^[The data used in this exercise can be found in the **openintro** R package: [`migraine`](http://openintrostat.github.io/openintro/reference/migraine.html).] [@Allais:2011]
...
The distribution of responses is summarized below.^[The data used in this exercise can be found in the **openintro** R package: [`sinusitis`](http://openintrostat.github.io/openintro/reference/sinusitis.html).] [@Garbutt:2012]
...
A blank cell indicates that data for that variable was not available for a given respondent.^[The data used in this exercise can be found in the **openintro** R package: [`smoking`](http://openintrostat.github.io/openintro/reference/smoking.html).] 
