...
How many observations and how many variables does this data frame have?^[The data used in this exercise can be found in the **openintro** package: [`mcu_films`](http://openintrostat.github.io/openintro/reference/mcu_films.html).]
...
A blank cell indicates that ^[The data used in this exercise can be found in the **openintro** package: [`smoking`](http://openintrostat.github.io/openintro/reference/smoking.html).] 
