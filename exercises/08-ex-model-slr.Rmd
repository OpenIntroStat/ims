...
1.  **Match the correlation, Part III** Match each correlation to the
    corresponding scatterplot.^[The data used in this exercise can be found in the **openintro** package: [`corr_match`](http://openintrostat.github.io/openintro/reference/corr_match.html).]
    ...
    ![](figures/scatter_1){width="24.5%"}
    ![](figures/scatter_2){width="24.5%"}
    ![](figures/scatter_3){width="24.5%"}
    ![](figures/scatter_4){width="24.5%"}
...
1.  **Helmets and lunches** The scatterplot shows the relationship
    ...
    ![](figures/helmet_lunch.png){width="\\textwidth"}\
