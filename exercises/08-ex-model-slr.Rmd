...
Match each correlation to the corresponding scatterplot.^[The data used in this exercise can be found in the **openintro** R package: [`corr_match`](http://openintrostat.github.io/openintro/reference/corr_match.html).]
...
The scatterplot below shows the relationship between height and shoulder girth (circumference of shoulders measured over deltoid muscles), both measured in centimeters.^[The data used in this exercise can be found in the **openintro** R package: [`bdims`](http://openintrostat.github.io/openintro/reference/bdims.html).]
...
The scatterplot below displays the distance between each stop (in miles) and the amount of time it takes to travel from one stop to another (in minutes).^[The data used in this exercise can be found in the **openintro** R package: [`coast_starlight`](http://openintrostat.github.io/openintro/reference/coast_starlight.html).]
...
Temperature is measured in degrees Fahrenheit (F) and age is measured in weeks.^[The data used in this exercise can be found in the **openintro** R package: [`babies_crawl`](http://openintrostat.github.io/openintro/reference/babies_crawl.html).]
...
The correlation between travel time and distance is 0.636.^[The data used in this exercise can be found in the **openintro** R package: [`coast_starlight`](http://openintrostat.github.io/openintro/reference/coast_starlight.html).]
...
The correlation between height and shoulder girth is 0.67.^[The data used in this exercise can be found in the **openintro** R package: [`bdims`](http://openintrostat.github.io/openintro/reference/bdims.html).]
...
There are 52 observations, each corresponding to a state in the US. Puerto Rico and District of Columbia are also included.^[The data used in this exercise can be found in the **openintro** R package: [`urban_owner`](http://openintrostat.github.io/openintro/reference/urban_owner.html).]
...
Does this point have high leverage? Is it an influential point?^[The data used in this exercise can be found in the **openintro** R package: [`babies_crawl`](http://openintrostat.github.io/openintro/reference/babies_crawl.html).]
...
The diameter of the tree is measured 4.5 feet above the ground.^[The data used in this exercise can be found in the **datasets** R package: [`trees`](https://stat.ethz.ch/R-manual/R-devel/library/datasets/html/trees.html).]
