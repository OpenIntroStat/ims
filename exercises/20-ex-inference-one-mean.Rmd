...
Summary statistics for the distribution of heights (in centimeters), along with a histogram, are provided below.^[The data used in this exercise can be found in the **openintro** R package: [`bdims`](http://openintrostat.github.io/openintro/reference/bdims.html).] [@Heinz:2003]
    ...
    ggplot(bdims, aes(x = hgt)) +
      ...
      labs(x = "Height (in centimeters)", y = "Count")
    ```
...
The histogram below shows the sample distribution of bootstrapped means from 1,000 different bootstrap samples.^[The data used in this exercise can be found in the **openintro** R package: [`bdims`](http://openintrostat.github.io/openintro/reference/bdims.html).] [@Heinz:2003]
    ...
    bdims %>%
      ...
      labs(
        x = "Boostrapped means, adult heights",
        y = "Count"
      ) +
