...
2.  **Decision errors and comparing proportions II.** In the following research studies, conclusions were made based on the data provided.
    ...
    a.  Of registered voters in California, the proportion who report not knowing enough to voice an opinion on whether or not they support off shore drilling is different across those who have a college degree and those who do not.
...
6.  **Diabetes and unemployment.** A Gallup poll surveyed Americans about their employment status and whether or not they have diabetes.
