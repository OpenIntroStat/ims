...
2.  **Hispanic population.** The US census collects data on race and ethnicity of Americans, among many other variables.
...
3.  **NYC marathon winners.** The histogram and box plots below show the distribution of finishing times for male and female (combined) winners of the New York City Marathon between 1970 and 2023.[^_05-ex-explore-numerical-7]
