...
county <- county %>%
  mutate(
    ...
    pop_change_2levels = if_else(pop_change_3levels == 0, "gain", "no gain")
  )

n_pop_no_gain     <- county %>% filter(pop_change_3levels == "no gain") %>% nrow()
...
We are missing 2017 population data from `r n_missing_pop2017`, and of the remaining `r n_with_pop_change` counties, in `r n_pop_gain` the population increased from 2010 to 2017 and in the remaining `r n_pop_no_gain`.


There were 1,454 counties where the population increased from 2010 to
2017, and there were 1,672 counties with no gain (all but one were a
loss). A random sample of 100 counties from the first group and 50 from
the second group are shown in ...
...
::: {.alltutorials}
[Tutorial 2: Summarizing and visualizing data
](https://openintrostat.github.io/ims-tutorials/02-summarizing-and-visualizing-data/)
:::

::: {.singletutorial}
[Tutorial 1 - Lesson 1: Visualizing categorical data](https://openintro.shinyapps.io/ims-02-summarizing-and-visualizing-data-01/)
:::

::: {.singletutorial}
[Tutorial 1 - Lesson 2: Visualizing numerical data](https://openintro.shinyapps.io/ims-02-summarizing-and-visualizing-data-02/)
:::

::: {.singletutorial}
[Tutorial 1 - Lesson 3: Summarizing with statistics](https://openintro.shinyapps.io/ims-02-summarizing-and-visualizing-data-03/)
:::

::: {.singletutorial}
[Tutorial 1 - Lesson 4: Case study](https://openintro.shinyapps.io/ims-02-summarizing-and-visualizing-data-04/)
:::
...
::: {.singlelab}
[Lab 1: Intro to data]http://openintrostat.github.io/oilabs-tidy/02_intro_to_data/intro_to_data.html)
:::
