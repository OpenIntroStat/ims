...
The sample mean is often labelled $\bar{x}$.
...
The purpose of labelling these points -- instead of extending the whiskers to the minimum and maximum observed values -- is to help identify any observations that appear to be unusually distant from the rest of the data.
...
Table \@ref(tab:loan-home-app-type-row-proportions) shows **row proportions** for the Table \@ref(tab:loan-home-app-type-totals), which are computed as the counts divided by their row totals.
