...
- [Chapter -@sec-foundations-decion-errors] you will be presented with a structure for describing when and how errors can happen within statistical inference. (change to Decision errors from Decision Errors)
