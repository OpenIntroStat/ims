...
::: {.data data-latex=""}
These data can be found in the [**openintro**](http://openintrostat.github.io/openintro) R package: [`ask`](http://openintrostat.github.io/openintro/reference/ask.html).
:::
...
To investigate whether 40.13 is large enough to indicate the observed and expected counts are significantly different, we need to understand what values of the chi-squared statistic would happen just due to chance.
...
::: {.data data-latex=""}
These data can be found in the [**openintro**](http://openintrostat.github.io/openintro) R package: [`diabetes2`](http://openintrostat.github.io/openintro/reference/diabetes2.html).
:::
